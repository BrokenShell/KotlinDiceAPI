...
val homepage_html: String = listOf(
    "<!DOCTYPE html>",
    "<html lang='en'>",
    "<head>",
    "<meta charset='UTF-8'>",
    ...
    "<br>",
    "<h3>Abstract</h3>",
    "<p>YARGA provides convenient access to high-performance thread local random value generators via its friendly API.</p>",
    "<br>",
    "<h3>YARGA Tech Stack</h3>",
    "<ul>",
    "<li>RNG Engine: Fortuna for Java</li>",
    "<li>JVM: Kotlin (Java 11)</li>",
